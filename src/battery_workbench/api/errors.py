...
class ErrorCode(str, Enum):
    ...
    # BRW-024R intake extensions (additive, task pack §26)
    UNSUPPORTED_FILE_FORMAT = "UNSUPPORTED_FILE_FORMAT"
    AMBIGUOUS_ADAPTER = "AMBIGUOUS_ADAPTER"
    DUPLICATE_ASSET = "DUPLICATE_ASSET"
    INTAKE_NOT_VALIDATED = "INTAKE_NOT_VALIDATED"
    INTAKE_ALREADY_COMMITTED = "INTAKE_ALREADY_COMMITTED"
...
HTTP_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.UNSUPPORTED_FILE_FORMAT: 409,
    ErrorCode.AMBIGUOUS_ADAPTER: 409,
    ErrorCode.DUPLICATE_ASSET: 409,
    ErrorCode.INTAKE_NOT_VALIDATED: 409,
    ErrorCode.INTAKE_ALREADY_COMMITTED: 409,
    ErrorCode.UPLOAD_TOO_LARGE: 413,
    ErrorCode.ASSET_ROLE_CONFLICT: 409,
}
