"""Ultrasound adapter for BRW-007.

Purely a wrapper around the existing BRW-005 ultrasound parser service. It does
not re-implement TXT splitting, waveform parsing, or the Zarr writer.
"""
...
class UltrasoundAdapter:
    """Owns the ``ultrasound`` modality; delegates to the BRW-005 service."""

    modality = "ultrasound"
    adapter_name = "UltrasoundAdapter"
    ...
    def expected_output_paths(
        ...
        return [Path(processed_root) / "ultrasound" / battery_id / experiment_id]
    ...
    def import_assets(
        ...
        *,
        ...
        try:
            ...
            manifest = write_ultrasound_experiment(parsed, processed_root)
